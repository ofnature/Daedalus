...
public static class JobSectionHeader
{
    ...
    private static readonly Dictionary<ConfigSection, (string Job, string Codename, JobValidation State)> Ledger = new()
    {
        ...
        [ConfigSection.Scholar]     = ("Scholar", "Athena", JobValidation.Untested),
        [ConfigSection.Astrologian] = ("Astrologian", "Astraea", JobValidation.Validated),
        [ConfigSection.Sage]        = ("Sage", "Asclepius", JobValidation.Validated),
        [ConfigSection.Monk]        = ("Monk", "Kratos", JobValidation.Validated),
        [ConfigSection.Dragoon]     = ("Dragoon", "Zeus", JobValidation.Pending),
        ...
        [ConfigSection.Bard]        = ("Bard", "Calliope", JobValidation.Untested),
        ...
        [ConfigSection.BlackMage]   = ("Black Mage", "Hecate", JobValidation.Untested),
        [ConfigSection.Summoner]    = ("Summoner", "Persephone", JobValidation.Untested),
