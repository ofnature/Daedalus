...
- The mob/spot list is session-only for now (not saved on logout) — saved farm profiles and automatic "which mobs drop this item" lookup are planned next (see docs/farm-mode.md)
