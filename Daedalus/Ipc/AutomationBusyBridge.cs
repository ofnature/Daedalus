...
/// <item>Parcae — <c>Parcae.IsBusy</c> == true while a FATE-farming run is driving the character.
/// Parcae picks the FATE, teleports/paths to it and holds the FATE-tagged target; every kill is
/// ours. (It also calls the RSR-compat <c>ChangeOperatingMode</c> per engage, which shows as
/// "Quest" — this bridge is what names the source "Parcae" and keeps the override up between FATEs.)</item>
/// </list>
/// </summary>
/// <remarks>
